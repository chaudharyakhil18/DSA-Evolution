...
- [ ] **Arrays & Hashing** – frequency maps, prefix sums, in-place operations, common tricks (two-sum, subarray sums, etc.).
- [ ] **Two Pointers** – opposite ends pointers, fast/slow pointers, partitioning, in-place removal, pair problems.
- [ ] **Sliding Window** – fixed and variable windows, counting/maximum/minimum subarrays, using hash maps in windows.
...
- [ ] **Backtracking** – recursion trees, generating subsets/permutations, constraints pruning.
- [ ] **Heaps & Priority Queues** – top-k problems, merging, streaming data, scheduling with priorities.
- [ ] **Intervals** – merging, insertion, overlap checks, sweep-line style reasoning.
- [ ] **Binary Search** – search on answer, custom conditions, edge-case handling, monotonic predicates.
- [ ] **Bit Manipulation** – masks, toggling bits, subsets via bits, XOR tricks.
...
2. Solve or add a problem in that pattern’s folder.
